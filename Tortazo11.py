...
class Cli(cli.Application):
    ...
    def loadAndExecute(self, listPlugins, torNodesFound, pluginArguments=None):
        self.logger.warn(term.format("[-] Sorry, the plugin system is not available in the executable file of Tortazo. Please, execute the Tortazo.py script using the Python interpreter to use the full features of the tool.", term.Color.RED))
