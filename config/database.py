...
createTableTorNodeData="create table if not exists TorNodeData (id integer primary key autoincrement, host varchar, state varchar, reason varchar, nickName varchar, fingerprint varchar, torVersion varchar, contact varchar, scanId integer, operative_system varchar(20), FOREIGN KEY (scanId) REFERENCES Scan(scanId))"
...
createTableTorNodeDataServerDB="create table if not exists TorNodeData (id serial primary key , host varchar, state varchar, reason varchar, nickName varchar, fingerprint varchar, torVersion varchar, contact varchar, scanId integer, operative_system varchar(20), FOREIGN KEY (scanId) REFERENCES Scan(id))"
...
updateTorScanServerDB="update Scan set numNodes = %s where id = %s RETURNING id"
