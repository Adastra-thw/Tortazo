...
class nessusPlugin(BasePlugin):
    ...
    def help(self):
        ...
        tableHelp.add_row(['userEdit', 'Edit the user specified', "self.userAdd('adastra','new_password',1)"])
        ...
        tableHelp.add_row(['scanStop', 'Create a new scan with the specified relay.', "self.scanStop(<SCAN_UUID>)"])
        ...
        tableHelp.add_row(['scanTemplateByRelay', 'Create a new scan template (scheduled) with the specified relay.', "self.scanTemplateByRelay(<POLICY_ID>,<IP_OR_NICKNAME>,<IP_OR_NICKNAME>)"])
        tableHelp.add_row(['scanTemplateEditAllRelays', 'Edit the scan template specified with all relays loaded.', "self.scanTemplateEditAllRelays(<TEMPLATE_UUID>,<TEMPLATE_NEW_NAME>,<POLICY_ID>)"])
