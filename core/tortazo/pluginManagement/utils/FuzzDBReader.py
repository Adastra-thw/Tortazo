...
class FuzzDBReader:
    ...
    def getDirListFromFuzzDB(self):
        ...
        largeDirs = open('fuzzdb/Discovery/PredictableRes/raft-large-directories.fuzz.txt', 'r')
        largeDirsLowercase = open('fuzzdb/Discovery/PredictableRes/raft-large-directories-lowecase.fuzz.txt', 'r')
        largeFiles = open('fuzzdb/Discovery/PredictableRes/raft-large-files.fuzz.txt', 'r')
        largeFilesLowercase = open('fuzzdb/Discovery/PredictableRes/raft-large-directories-lowecase.fuzz.txt', 'r')
        largeWords = open('fuzzdb/Discovery/PredictableRes/raft-large-words.fuzz.txt', 'r')
        largeWordsLowercase = open('fuzzdb/Discovery/PredictableRes/raft-large-words-lowercase.fuzz.txt', 'r')
        mediumDirs = open('fuzzdb/Discovery/PredictableRes/raft-medium-directories.fuzz.txt', 'r')
        mediumDirsLower =  open('fuzzdb/Discovery/PredictableRes/raft-medium-directories-lowercase.fuzz.txt', 'r')
        mediumFiles =  open('fuzzdb/Discovery/PredictableRes/raft-medium-files.fuzz.txt', 'r')
        mediumFilesLower =  open('fuzzdb/Discovery/PredictableRes/raft-medium-files-lowercase.fuzz.txt', 'r')
        mediumWords =  open('fuzzdb/Discovery/PredictableRes/raft-medium-words.fuzz.txt', 'r')
        mediumWordsLower =  open('fuzzdb/Discovery/PredictableRes/raft-medium-words-lowercase.fuzz.txt', 'r')
        smallDirs =  open('fuzzdb/Discovery/PredictableRes/raft-small-directories.fuzz.txt', 'r')
        smallDirsLower =  open('fuzzdb/Discovery/PredictableRes/raft-small-directories-lowercase.fuzz.txt', 'r')
        smallFiles =  open('fuzzdb/Discovery/PredictableRes/raft-small-files.fuzz.txt', 'r')
        smallFilesLower =  open('fuzzdb/Discovery/PredictableRes/raft-small-files-lowercase.fuzz.txt', 'r')
        smallWords =  open('fuzzdb/Discovery/PredictableRes/raft-small-words.fuzz.txt', 'r')
        smallWordsLower =  open('fuzzdb/Discovery/PredictableRes/raft-small-words-lowercase.fuzz.txt', 'r')
